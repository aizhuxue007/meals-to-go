...
const CheckoutNavigator = () => {
  return (
    ...
    >
      ...
      <CheckoutStack.Screen name="CheckoutErrorScreen" component={CheckoutErrorScreen} />
      <CheckoutStack.Screen name="CheckoutSuccessScreen" component={CheckoutSuccessScreen} />
    </CheckoutStack.Navigator>
  );
};
